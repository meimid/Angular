...
@Component({
  ...
  templateUrl: './list-carton.component.html',
  styleUrls: ['./list-carton.component.scss']
})
export class ListCartonComponent implements OnInit {
rows= [];
AllAccount= [];
AllAccountPr= [];
  count = 0;
  ...
  fetch(cb) {
		...
		this.prdSer.getAllCartonShortList().subscribe(data => {		 
